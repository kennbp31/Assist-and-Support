var SkypeButton = new (function () {
  ...
  this.installSkypeMsg =
    "Please install Skype application in order to make this call or send a message.";
  ...
  this.assetMargin =
    this.assetSize >= this.assetMarginMinimum
      ? this.assetSize
      : this.assetMarginMinimum;
  ...
  this.assetColor = new this.SkypeUriAssetColorMap(
    this.assetColorPathDefault,
    this.assetColorFontDefault
  );
  this.assetSizeMap = {};
              ...
              if (navigator.userAgent.indexOf("Mac OS X 10_8") !== -1) {
                ...
                if (navigator.userAgent.indexOf("Android") !== -1) {
                  ...
                  if (navigator.userAgent.indexOf("Windows Phone 8") !== -1) {
                    ...
                    if (
                      navigator.userAgent.match(/OS 7_[0-9_]+ like Mac OS X/i)
                    ) {
                      this.isIOS7 = true;
                      this.detectedPlatform = "iOS7";
                    } else {
                      if (
                        navigator.userAgent.match(/OS 6_[0-9_]+ like Mac OS X/i)
                      ) {
                        this.isIOS6 = true;
  ...
  function f() {
    alert(
      "Sorry this device doesn't support Skype Buttons yet. Please add " +
        this.participants[0] +
        " as a contact in your Skype Client to MAKE this call."
    );
  }
  function i(r) {
  ...
  function k(r, s) {
    ...
    if (typeof this.analyzeSkypeUri === "function") {
      ...
      var t = {};
      t.prop3 =
        "image size / color: " + this.imageSize + " / " + this.imageColor;
      t.prop4 =
        "video / list participants / list topic: " +
        this.video +
        " / " +
  ...
  function l(L) {
    ...
    if (y.length !== 0) {
      ...
      if (P === null) {
        ...
        if (
          L.name !== undefined &&
          L.name !== null &&
          (L.participants === undefined || L.participants === null)
        ) {
          alert(
            "Error! Required member 'participants' omitted or specified as null"
          );
          return false;
        }
      }
      ...
      alert(
        "Error! Required member 'element' (Skype URI parent element) omitted or specified as null"
      );
      return false;
    }
    ...
    if (
      ...
      if (
        (this.isWinPhone8 && this.isIE10) ||
        (this.isAndroid && this.isAndroidBrowser)
      ) {
        A = "javascript://";
        v += " SkypeButton.displayNotSupportedMsg();";
      } else if (this.isAndroid && this.isChrome) {
        v =
          "SkypeButton.trySkypeUri_Android_Chrome('" +
          this.analyzeCrumbIndex +
          "');";
        A = B;
      } else {
        ...
        if (this.isIE10 || this.isIE9 || this.isIE8) {
          ...
          if (
            (this.isIOS7 || this.isIOS6 || this.isIOS5 || this.isIOS4) &&
            this.isSafari
          ) {
    ...
    z.setAttribute(
      ...
      "border:0; margin:" +
        this.assetMargin +
        "px; vertical-align:" +
        this.assetSizeMap["size" + this.assetSize].verticalOffset +
        "px;"
    );
    ...
    if (this.name === this.dropdownLinks.name) {
      z.setAttribute(
        "onmouseover",
        "SkypeButton.showDropdown('dropdown_" +
          this.element +
          "'); return false;"
      );
      z.setAttribute(
        "onmouseout",
        "SkypeButton.hideDropdown('dropdown_" +
          this.element +
          "'); return false;"
      );
      ...
      if (this.name === this.chatLinks.name) {
        if (this.participants.length === 1) {
          v =
            "SkypeWebControl.SDK.Chat.startChat({ConversationType: 'person', ConversationId: '" +
            this.participants[0] +
            "'});";
        } else {
          v =
            "SkypeButton.tryAnalyzeSkypeUri('chat', '" +
            this.analyzeCrumbIndex +
            "');" +
            v;
        }
        ...
        v =
          "SkypeButton.tryAnalyzeSkypeUri('call', '" +
          this.analyzeCrumbIndex +
          "');" +
          v;
      }
    ...
    uriPara.setAttribute(
      "style",
      "font-size:" + (this.assetSize - 2) + "px; color:" + this.assetColor.font
    );
    ...
    if (this.name === this.dropdownLinks.name) {
      ...
      r.setAttribute(
        "style",
        "display: none; position: absolute; margin-top: " +
          O +
          "px; margin-left: " +
          J +
          "px; width: 200px; padding-left: 20px; padding-right: 20px; border: 2px solid #00AFF0; background-color: white; color: #00AFF0; line-height: 50px; list-style: none; list-style-type: none;"
      );
      r.setAttribute(
        "onmouseover",
        "SkypeButton.showDropdown('dropdown_" +
      ...
      I.setAttribute(
        "style",
        "text-decoration: none; color: #00AFF0; font-size: 16px;"
      );
      I.setAttribute("href", A);
      K =
        "SkypeButton.tryAnalyzeSkypeUri('dropdownCall', '" +
        this.analyzeCrumbIndex +
        "');" +
        v;
      I.setAttribute(
        "onclick",
        K.replace("?" + this.dropdownLinks.name, "?" + this.callLinks.name)
      );
      ...
      K =
        "SkypeButton.tryAnalyzeSkypeUri('dropdownChat', '" +
        this.analyzeCrumbIndex +
        "');" +
        v;
      ...
      if (this.participants.length === 1) {
        ...
        E.setAttribute(
          "onclick",
          K.replace("?" + this.dropdownLinks.name, "?" + this.chatLinks.name)
        );
      }
      I.innerHTML = "Call";
      t.appendChild(I);
  ...
  function j(u, r) {
    ...
    this.focusLinks.linkImage =
      this.assetPrefix +
      "Skypeicon" +
      this.assetColor.path +
      this.assetSize +
      "px.png";
    this.callLinks.linkImage =
      this.assetPrefix +
      "callbutton" +
      this.assetColor.path +
      this.assetSize +
      "px.png";
    this.videoLinks.linkImage =
      this.assetPrefix +
      "callbutton" +
      this.assetColor.path +
      this.assetSize +
      "px.png";
    this.chatLinks.linkImage =
      this.assetPrefix +
      "chatbutton" +
      this.assetColor.path +
      this.assetSize +
      "px.png";
    this.multiChatLinks.linkImage =
      this.assetPrefix +
      "chatbutton" +
      this.assetColor.path +
      this.assetSize +
      "px.png";
    this.dropdownLinks.linkImage =
      this.assetPrefix +
      "dropdowncallbutton" +
      this.assetColor.path +
      this.assetSize +
  ...
  function h(r) {
    ...
    var t = new Date();
    this.detectSkypeClientFrameId =
      "_detectSkypeClient_" + t.getTime().toString();
